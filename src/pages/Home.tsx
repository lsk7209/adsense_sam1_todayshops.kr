...
import { Calculator, TrendingUp, DollarSign, Briefcase, Calendar } from 'lucide-react';
  ...
  return (
    <>
      <SEO
        ...
        keywords="부가세 계산기, 마진 계산기, 연봉 계산기, 무료 계산기, 프리랜서 계산기"
      />
      ...
      <div className="container section">
        ...
        <div className="tools-grid">
          ...
          <Link to="/freelance-calculator" className="tool-card card">
            <div className="tool-card__icon">
              <Briefcase size={32} />
            </div>
            <h2 className="tool-card__title">프리랜서 3.3% 계산기</h2>
            <p className="tool-card__desc">
              프리랜서 및 아르바이트 급여 계산.<br />
              3.3% 원천징수 세금 및 실수령액 확인.
            </p>
            <span className="btn btn-primary btn-full">계산하기</span>
          </Link>

          <Link to="/holiday-allowance-calculator" className="tool-card card">
            <div className="tool-card__icon">
              <Calendar size={32} />
            </div>
            <h2 className="tool-card__title">주휴수당 계산기</h2>
            <p className="tool-card__desc">
              2025년 최저시급 기준 주휴수당 자동 계산.<br />
              주 15시간 이상 근무 시 필급여 확인.
            </p>
            <span className="btn btn-primary btn-full">계산하기</span>
          </Link>
        </div>
